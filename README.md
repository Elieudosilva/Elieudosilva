# Olá, eu sou o Elieudo Silva! 👋📱

### Desenvolvedor Android | Kotlin & Jetpack Compose

Desenvolvedor Android em formação, focado em criar soluções eficientes e com ótima experiência para o usuário. Tenho um forte background em vendas, o que me garante facilidade de comunicação, trabalho em equipe e uma visão estratégica de produto que vai muito além do código.

---

### 🚀 Sobre mim
- 🎓 Estudando Android com foco em projetos reais na comunidade **Nova Era**.
- 👥 Atuando no desenvolvimento do app **BabyTracker** em equipe, utilizando um fluxo profissional (Git, Pull Requests e Code Review).
- 💻 Constantemente praticando através de desafios de código baseados em requisitos reais de software.
- 🎯 Buscando minha primeira oportunidade como Estagiário ou Desenvolvedor Júnior Android.
